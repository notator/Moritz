...
namespace Moritz.Spec
{
	public class Seq
	{
		...
		/// <summary>
		/// Converts this Seq to a "Sequence" by padding each Trk at the beginning and end with rests.
		/// Returns the changed Trks as a list of VoiceDefs.
		...
		/// </summary>
		public List<VoiceDef> ToSequence()
		{
			...
			AssertSequenceConsistency();

			return voiceDefs;
		}
		#region private to ToSequence
		/// <summary>
		...
		/// </summary>
		private void AssertSequenceConsistency()
		{
