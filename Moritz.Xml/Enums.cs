...
namespace Moritz.Xml
{
	...
	public enum Dynamic
	{
		...
		// note that the following are expression controls, not dynamics!
		//[Description("|")]
		//fp,
		//[Description("s")]
		//sf,
	...
	public enum AssistantsDurationsType
	{
        ...
        SymbolsRelative,
        // This type is used when playing a recording. It is never saved in a performance options file.
        // [Description("recordedRealTime")]
        PerformRecording,
    }
