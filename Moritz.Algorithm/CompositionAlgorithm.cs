...
namespace Moritz.Algorithm
{
    ...
    public abstract class CompositionAlgorithm
    {
        ...
        /// <summary>
        /// Barlines will be fit to the MidiChordDefs in the trks.
        /// </summary>
        ...
        private static void AddLyricsToVoiceDef(VoiceDef voiceDef, SortedDictionary<int, string> lyrics)
        {
            if(lyrics.Count > 0)
            {
                Debug.Assert(voiceDef is Trk);   // This must be the case (Feb. 2025)
        ...
        private class MainBar : Bar
        {
            ...
            /// <summary>
            /// A MainBar contains a list of voiceDefs (that are abstract Trks). A Seq can only contain Trks.
            ...
            /// <param name="initialClefPerChannel">Cannot be null. Count must be seq.Trks.Count</param>>
