...
namespace Moritz.Algorithm.SongSix
{
    internal class Furies2 : OutputVoiceDef
    {
        ...
        private OutputVoiceDef GetF2Finale(List<Palette> palettes, Krystal krystal, Dictionary<string, int> msPositions)
        {
            ...
            OutputVoiceDef finalePart1 = f2FinalePalette1.NewOutputVoiceDef(krystal);
            Transform(finalePart1, msPositions, strandIndices);
            OutputVoiceDef finalePart2 = f2FinalePalette2.NewOutputVoiceDef(krystal);
            Transform(finalePart2, msPositions, strandIndices);
            OutputVoiceDef postlude = f2PostludePalette.NewOutputVoiceDef(krystal);
