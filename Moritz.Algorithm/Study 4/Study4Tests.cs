...
namespace Moritz.Algorithm.Study4
{
	public partial class Study4Algorithm : CompositionAlgorithm
	{
		...
		public void Tests()
		{
			...
			Mode test1_StartMode = new Mode(0, 0, absPitchSet1_Start);

			HashSet<int> absPitchSet1_Target = new HashSet<int>() { 7, 0, 11, 9, 6 };
			Mode test1_TargetMode = new Mode(0, 0,absPitchSet1_Target);
			...
			Mode test3_StartMode_Clone = test1_StartMode.Clone() as Mode;
