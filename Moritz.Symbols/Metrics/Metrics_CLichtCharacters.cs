            ...
            : base(rest.DurationClass, rest.FontHeight, restClass)
        {
            ...
            switch(rest.DurationClass)
            {
                ...
                case DurationClass.semibreve:
                    ...
                    if(numberOfStafflines == 1)
                        Move(0F, gap);
                    _ledgerlineBlockMetrics = new LedgerlineBlockMetrics(Left - _ledgerlineStub, Right + _ledgerlineStub, ledgerlineStrokeWidth, CSSObjectClass.ledgerlines);
                ...
                case DurationClass.minim:
                    Move(gap * 0.18F, 0);
                    _ledgerlineBlockMetrics = new LedgerlineBlockMetrics(Left - _ledgerlineStub, Right + _ledgerlineStub - (gap * 0.3F), ledgerlineStrokeWidth, CSSObjectClass.ledgerlines);
