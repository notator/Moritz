...
namespace Moritz.AssistantComposer
{
    ...
    /// <para>foreach(IUniqueMidiDurationDef iumdd in SongSixVoiceDef) { ... }</para>
    /// <para>It is also indexable, as in:</para>
    /// <para>IUniqueMidiDurationDef iumdd = SongSixVoiceDef[index];</para>
    /// </summary>
    public class SongSixVoiceDef : IEnumerable
    {
        ...
        /// </summary>
        public SongSixVoiceDef(List<IUniqueMidiDurationDef> lmdds)
        {
        ...
        {
            _uniqueMidiDurationDefs.AddRange(SongSixVoiceDef.UniqueMidiDurationDefs);
            SetMsPositions();
        }
        /// <summary>
        ...
        {
            _uniqueMidiDurationDefs.InsertRange(index, SongSixVoiceDef.UniqueMidiDurationDefs);
            SetMsPositions();
        }
        /// <summary>
        ...
        /// </summary>
        private List<IUniqueMidiDurationDef> GetReplacementList(IUniqueMidiDurationDef originalRest, SongSixVoiceDef iVoiceDef)
        {
        ...
        /// Note that clef changes must be inserted backwards per SongSixVoiceDef, so that IUniqueMidiDurationDef
