...
namespace Moritz.AssistantComposer
{
    ...
    public class OutputVoiceDef : VoiceDef
    {
        ...
        /// </summary>
        protected OutputVoiceDef(Palette palette, List<int> sequence) 
            :base()
        {
            int msPosition = 0;
        ...
        /// <summary>
        /// Creates an OutputVoiceDef using the sequence of values in the krystal.
        /// </summary>
        public OutputVoiceDef (Palette palette, Krystal krystal)
        ...
        /// </summary
        public OutputVoiceDef(Palette palette)
        {
